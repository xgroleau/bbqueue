...
#[cfg(test)]
mod tests {
    use bbqueue::{BBQueueStatic, Error as BBQError};
    ...
    fn static_allocator() {
        ...
        static BBQ1: BBQueueStatic<6> = BBQueueStatic::new_static();
        static BBQ2: BBQueueStatic<6> = BBQueueStatic::new_static();
    ...
    #[test]
    fn zero_sized_grant() {
        let bb: BBQueueStatic<1000> = BBQueueStatic::new_static();
    ...
    #[test]
    fn frame_wrap() {
        let bb: BBQueueStatic<22> = BBQueueStatic::new_static();
        let (mut prod, mut cons) = bb.try_split_framed().unwrap();
    ...
    #[test]
    fn frame_big_little() {
        let bb: BBQueueStatic<65536> = BBQueueStatic::new_static();
        let (mut prod, mut cons) = bb.try_split_framed().unwrap();
    ...
    fn split_sanity_check() {
        let bb: BBQueueStatic<10> = BBQueueStatic::new_static();
        let (mut prod, mut cons) = bb.try_split().unwrap();
